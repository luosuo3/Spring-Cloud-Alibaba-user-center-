...
public class JwtOperator {
  ...
  /*  public static void main(String[] args) {
        ...
        objectObjectHashMap.put("name", "王峥");
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJuYW1lIjoi546L5bOlIiwiaWQiOiIxIiwiaWF0IjoxNTkzNjkzNTg5LCJleHAiOjE1OTQ5MDMxODl9.ZPDPpa_HCUgCe_hrxA1ESLZXmzlHzhEVCgL46gmrpjY";
        ...
        String encodedHeader = "eyJuYW1lIjoi546L5bOlIiwiaWQiOiIxIiwiaWF0IjoxNTkzNjkzNTg5LCJleHAiOjE1OTQ5MDMxODl9";
        // 测试4: 解密Header
